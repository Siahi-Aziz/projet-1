...
if [ $# -eq 0 ];then  #test si le nbr d'arguments = 0 , si vrai retourne erreur 
	...
	if [ "$1" = "-Name" ];then # donc créer la commande -Name
		...
		echo "Arguments: ;-Name : Afficher le nom de l’application .;-Syntax : Afficher la syntaxe de commande initdev./-args : Lister les arguments et donner une description de chaque argument./;-author : Afficher le nom et l’email de l’auteur de l’application."; 
		elif [ "$1" = "-Syntax" ];then # créer  la commande -Syntax
		echo "Syntaxes d'utilisations: syntaxe 1 : initdev [commande : -help , -Name , -Syntax , -args , -author ] ; syntaxe 2: initdev [nom] ;syntaxe 3: initdev [nom] [langage/licence];syntaxe 4: initdev [nom] [langage/licence/git] [langage/licence/git]; syntaxe 5: initdev [nom] [langage/licence/git] [langage/licence/git] [langage/licence/git];Conditions d'utilisations:
1)  1er argument dans toute les syntaxes doit etre le nom de projet;/2) dans la meme commande Vous pouvez ecrire le meme argument une seul fois ;/3)  Vous pouvez créer un projet sans la precision de  license , langage voir 1ere syntaxe ;/2)  vous pouvez créer un projet avec une licence que vous voulez sans precision  le langage voir 2eme syntaxe;/3) vous pouvez créer un projet avec une licence et un langage spécifié voir 3eme syntaxe ;/4) vous pouvez créer un projet avec un depot git mais vous devez preciser le langage voir 3eme syntaxe ;/5) vous pouvez créer un projet avec une licence , un langage specifique plus un depot initiale git voir 4eme syntaxe    "
		elif [ "$1" = "-args" ];then # créer  la commande -args
		echo " 
-Arguments * unicité d'argument ( vous ne pouvez pas utiliser  )/-help	*	affiche l'aide/-Name	*	affiche le nom de l'application /-Syntax	*	affiche les syntaxes d'utilisation de la commande/-args	*	affiche tous les arguments /-author	*	affiche le nom et l'e-mail de l'auteur de l'application/-C		Projet en langage C/-Py		Projet en langage Python/-Cpp ou -C++	Projet en langage C++/Latex		Projet d' ecriture en Latex/-BEAMER		Projet d' ecriture en BEAMER/-GPL		Projet avec une licence GENERAL PUBLIC LICENSE/-MIT		Projet avec une licence MIT/-git		créer  un fichier .gitignore et un depot git dans le repertoire du projet";
